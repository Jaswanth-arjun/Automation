...
function detectHonorific(name, headline = '') {
  if (!name) return 'sir';
  ...
  const femaleNames = new Set([
    ...
    'sarah', 'emily', 'jessica', 'rachel', 'hannah', 'laura', 'amanda', 'jennifer', 'ashley', 'stephanie',
  ...
  const maleExceptions = new Set([
    'shiva', 'krishna', 'rama', 'gupta', 'verma', 'sharma', 'mishra', 'chandra', 'surya', 'satya', 
    'aditya', 'teja', 'dharma', 'nanda', 'rudra', 'karthik', 'koushik', 'saikiran', 'saiteja', 'vamsi',
    'naga', 'venkat', 'balaji', 'subba'
  ]);

  if (maleExceptions.has(firstName)) return 'sir';

  if (firstName.endsWith('a') || firstName.endsWith('i') || firstName.endsWith('ee') || firstName.endsWith('ya') || firstName.endsWith('tha') || firstName.endsWith('shree')) {
    return 'mam';
  }
